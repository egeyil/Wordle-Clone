...
const pressKey = (key) => {
    ...
    // querySelector always selects the first thing it matches, 
    // so we are finding the very first thing that doesn't have the data 
    // letter, then we will add a letter to it.
...
const submitGuess = () => {
    const activeTiles = [...getActiveTiles()] // using querySelector syntax we are turning this into an array
    ...
    // take each letter from our tile and add it to the end of the word 
    // which will make up our guess
    ...
    // We pass all the information that's been typed in into flipTile function
}

const flipTile = (tile, index, array, guess) => {
    const letter = tile.dataset.letter; // get each letter of the tile
...
// the user can't type any more letters and overflow to the other row.
